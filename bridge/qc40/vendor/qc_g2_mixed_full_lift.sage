...
def Omega_set(f, p, n,  Es = None, Emins = None, potential_good_primes = True):
    ...
    # Restricted to the full five-square lift of mixed G1(15,8).
    # Exact zero-height certificates: unramified_height_primes.json and
    # zero_height_model_checks.json; proof in MIXED_GENUS2_BRIDGE.
    assert list(f) == [4092529,0,47287151,0,37608911,0,44182609]
    zero_height_primes = {3,5,13,37,1213,9397}
    Wqprimelist = [[K(0)] if q in zero_height_primes else w for q,w in zip(bad_primes,Wqprimelist)]

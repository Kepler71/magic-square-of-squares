...
try:
    ...
    Kp=Qp(p,prec)
    omega=[r7*Kp(7).log()+r17*Kp(17).log()+r23*Kp(23).log() for r7 in [QQ(-2),QQ(-4)/3] for r17 in [QQ(-2),QQ(0),QQ(2)] for r23 in [QQ(2),QQ(4)/3]]
    out['omega_theoretical_upper_bound']=12
    rat,extra=quadratic_chabauty_bielliptic(f,p,prec,Omega=omega,omega_info=True)
